...
//--------------------------------------------------------------------------------//
	...
	{
		$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
		$consulta =$objetoAccesoDato->RetornarConsulta("INSERT into sucursal (nombre,direccion,latitud,longitud,email,telefono,foto,id_encargado)values(:nombre,:direccion,:latitud,:longitud,:email,:telefono,:foto,:id_encargado)");
		$consulta->bindValue(':nombre',$sucursal->nombre, PDO::PARAM_STR);
		$consulta->bindValue(':direccion', $sucursal->direccion, PDO::PARAM_STR);
